...
--8--
insert into Address values((select id from Student where FirstName='Carey'),'500 Kingston Rd','Toronto','M4L 1V3','(416)694-8464','careym1@college.com')
insert into Address values((select id from Student where FirstName='Moses'),'315 St Germain Ave','Toronto','M5M 1W4','(416) 322-7518','mosesh2@college.com')
insert into Address values((select id from Student where FirstName='Debbie'),'234 Willow Ave','Toronto','M4E 3K7','(416) 699-8444','debbiec3@college.com')
